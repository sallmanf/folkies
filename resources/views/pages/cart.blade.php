        ...
        <div class="container">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            <div class="col-4 col-md-2">
              <div class="product-title">Rp {{ number_format($insurance_price = 3000) }}</div>
            ...
            <div class="col-4 col-md-2">
              <div class="product-title text-success">Rp {{ number_format($totalPrice = $totalPrice+$insurance_price+$shipping_price ?? 0) }}</div>
    ...
    <script>
      var locations = new Vue({
        ...
        methods: {
          ...
          getCostService () {
            document.getElementById('totalPrice').value = $totalPrice+$insurance_price+$shipping_price;
